...
{//orden en el que se esta dibujando el prisma 
	GLfloat vertice [8][3] = {
				...
				{-0.5*b,-0.5*h, 0.5},    //Coordenadas Vértice 1 V1
				{-0.5*b ,-0.5*h, -0.5},    //Coordenadas Vértice 2 V2
				{0.5*b ,-0.5*h, -0.5},    //Coordenadas Vértice 3 V3
				{0.5*b ,0.5*h, 0.5},    //Coordenadas Vértice 4 V4
				{0.5*b ,0.5*h, -0.5},    //Coordenadas Vértice 5 V5
				{-0.5*b ,0.5*h, -0.5},    //Coordenadas Vértice 6 V6
				{-0.5*b ,0.5*h, 0.5},    //Coordenadas Vértice 7 V7
				};
